...
echo "Step 2"; date	
if [ $GOTO_STEP -le 2 ] || [ $CONTINUE_ON == true ]; then
CONTINUE_ON=true
...
echo "Step 3"; date
if [ $GOTO_STEP -le 3 ] || [ $CONTINUE_ON == true ]; then
CONTINUE_ON=true
...
echo "Step 4"; date
if [ $GOTO_STEP -le 4 ] || [ $CONTINUE_ON == true ]; then
CONTINUE_ON=true
...
echo "Step 5"; date
if [ $GOTO_STEP -le 5 ] || [ $CONTINUE_ON == true ]; then
CONTINUE_ON=true
...
echo "Step 6"; date
if [ $GOTO_STEP -le 6 ] || [ $CONTINUE_ON == true ]; then
CONTINUE_ON=true
# Step 6, Sam to fastq
...
echo "Step 7"; date
if [ $GOTO_STEP -le 7 ] || [ $CONTINUE_ON == true ]; then
CONTINUE_ON=true
# Step 7, map fastq 
...
echo "Step 8"; date		
if [ $GOTO_STEP -le 8 ] || [ $CONTINUE_ON == true ]; then
CONTINUE_ON=true	
...
if [ $GOTO_STEP -le 9 ] || [ $CONTINUE_ON == true ]; then
CONTINUE_ON=true
...
echo "Step 10"; date
if [ $GOTO_STEP -le 10 ] || [ $CONTINUE_ON == true ]; then
CONTINUE_ON=true
...
echo "Step 11"; date
if [ $GOTO_STEP -le 11 ] || [ $CONTINUE_ON == true ]; then
CONTINUE_ON=true
...
echo "Step 12"; date
if [ $GOTO_STEP -le 12 ] || [ $CONTINUE_ON == true ]; then
CONTINUE_ON=true
# Step 12, map fastq 
...
echo "Step 13"; date
if [ $GOTO_STEP -le 13 ] || [ $CONTINUE_ON == true ]; then
CONTINUE_ON=true
...
echo "Step 14"; date
if [ $GOTO_STEP -le 14 ] || [ $CONTINUE_ON == true ]; then
CONTINUE_ON=true
...
echo "Step 15"; date
if [ $GOTO_STEP -le 15 ] || [ $CONTINUE_ON == true ]; then
CONTINUE_ON=true
