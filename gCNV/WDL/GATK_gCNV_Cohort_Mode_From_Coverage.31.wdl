# Workflow for creating a GATK GermlineCNVCaller denoising model and generating calls given a list coverage files for normal samples. Supports both WGS and WES.
#
# - Example invocation:
#
#       java -jar cromwell.jar run cnv_germline_cohort_workflow_from_coverage.wdl -i my_parameters.json
#
#############

import "https://api.firecloud.org/ga4gh/v1/tools/gCNV:cnv_common_tasks/versions/5/plain-WDL/descriptor" as CNVTasks

workflow CNVGermlineCohortWorkflowFromCoverage {
    ...
    File? ploidy_blacklist
    File ploidy_interval
    ...
    call DetermineGermlineContigPloidyCohortMode {
        input:
            ...
            preemptible_attempts = preemptible_attempts,
            ploidy_blacklist = ploidy_blacklist
    }
    ...
    output {
        File intervals = preprocessed_intervals
        Array[File] read_counts = count_files
